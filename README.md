...
- vaadinTest-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadinTest-ui: main application module, development time
- vaadinTest-production: module that produces a production mode WAR for deployment
