package it.matula.vaadinTest.client.samples;
...
import it.matula.vaadinTest.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@it.matula.vaadinTest.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
